...
sink(paste0(locations$results,"/pgrs-gs/pgcpgrs_into_psych",today,".txt"),append=FALSE)
...
for(i in 1:(length(traits))){
  ...
  sink(paste0(locations$results,"/pgrs-gs/pgcpgrs_into_psych",today,".txt"),append=TRUE)
